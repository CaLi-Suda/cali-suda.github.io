const translations = {
  en: {
    ...
    "team.zhuRole": "Professor",
    "team.zhuTitle": "Professor, School of Future Science and Engineering",
    "team.degreeLabel": "Degree",
    "team.zhuDegree": "PhD in Engineering",
    "team.schoolLabel": "Alma mater",
    "team.zhuSchool": "Zhejiang University",
    "team.zhuHonor1": "Co-chair of the UWA Audio Standards Group",
    "team.zhuHonor2": "Deputy Director of the Sound and Music Technology Committee of CAIA",
    "team.researchDirection": "Research Directions",
    "team.zhuResearch": "Intelligent acoustics and artificial intelligence, with a focus on embodied auditory intelligence for human-machine integration, covering acoustic and audio signal processing, speech and audio coding, sound source localization and tracking, audio separation and enhancement, spatial audio reproduction, and active sound field control.",
    "team.zhuAchievements": "Prof. Zhu has published more than 70 papers in leading international conferences and journals and holds over 30 patents. In May 2019, Shanghai University and Huawei jointly appointed him to advance the industrialization of intelligent acoustics and audio. He led the development of an independently controllable spatial audio standard and ecosystem, successfully deployed on tens of millions of terminal devices. He also led multiple innovative audio technology projects at Huawei, built what was then the world's largest sound field laboratory, and initiated the Shenghua Cup and Advanced Audio Technology Competition, which have become major academic events in the field.",
