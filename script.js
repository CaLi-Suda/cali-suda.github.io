const translations = {
  en: {
    ...
    "about.body1": "CaLi is a research center of Soochow University. As a key supporting unit of the Jiangsu Provincial Key Laboratory for Language Computing and Application, it is an innovative talent development hub jointly supported by Jiangsu Province and Soochow University.",
    "about.body2": "The center brings together leading faculty, guided by an IEEE Fellow, former Huawei senior experts, and Jiangsu Industrial Professors. Direct research links with C9 universities connect academic exploration with frontier industrial needs.",
    "about.body3": "Starting from real industry problems, the center builds a deeply integrated innovation community across industry, academia, research, and application. It focuses on frontier core technologies such as embodied audition and distributed agents, connecting key technology breakthroughs with industrial deployment while cultivating innovative AI-era talent.",
